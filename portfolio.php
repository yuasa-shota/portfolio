...
<div id="wrapper">
  <section id="portfolio">
    <h2>ポートフォリオのサイト</h2>
    <div id="portfolio_top"> <h3>トップページ</h3><img src="<?php echo esc_url(get_theme_file_uri()); ?>/img/top_pc.png" alt="トップページのカンプPC表示"> <img src="<?php echo esc_url(get_theme_file_uri()); ?>/img/top_sp.jpg" alt="トップページのカンプsp表示">
      <section>
	  ...
	  <div id="portfolio_profile"><h3>自己紹介ページ</h3>
      ...
      <section>
        ...
        <p>キャリアの目標がフロントエンドエンジニアなので、コーディングの部分を強調して書く。自分の現状認識と目標を正直に書くことで、採用担当者様との認識のずれが小さくなるようにした。<br>
			その他の項目の末尾にはGithubの自分のページのURLを載せることで、具体的にコードをどのように書くか見たいと考えた採用担当者様がスムーズに見ることが出来るようにして、コーディングの熱量の高さが通じるようにした。
		  </p>
      </section>
	  </div>
  </section>
